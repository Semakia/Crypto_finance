...
class DashboardRepository
{
    ...
    public function getUserDashboardData(): array
    {
        ...
        $userInvest = InvestPackage::where('user_id', getLogInUserId())->get();
        $data['amountInvested'] = $userInvest->sum('amount_required');
        $data['userInvest'] = $userInvest;
        return $data;
    }

    /*public function getUserDashboardChartData(): array
    {
        $yourInvest = InvestPackage::where('user_id', getLogInUserId())->pluck('id');
