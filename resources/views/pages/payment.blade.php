                ...
                <div class="row">
                    <div class="col-xl-8">
                        ...
                        <div class="payment-left-section pb-100">
                            @if($campaign->goal)
                                {{ Form::open(['id'=>'campaignDonationForm','route' => 'campaign.payment' ,'class'=>'give-form mt-3' , 'autocomplete' => 'off']) }}
                                ...
                                <div class="tags d-flex flex-wrap pb-1 give-donation-amount donate-amount-buttons">
                                    @if($campaign->currency != 'inr')
                                        <div class="tag bg-light rounded-10  mb-3 ">
                                            <span class="single_amount currency prefilled-amount">25</span>
                                        </div>
                                    @endif
                                        <div class="tag bg-light rounded-10  mb-3">
                                            <span class="single_amount currency prefilled-amount">50</span>
                                        </div>
                                        <div class="tag bg-light rounded-10  mb-3 ">
                                            <span class="single_amount currency prefilled-amount">100</span>
                                        </div>
                                        <div class="tag bg-light rounded-10  mb-3 ">
                                            <span class="single_amount currency prefilled-amount">200</span>
                                        </div>
                                        <div class="tag bg-light rounded-10  mb-3 ">
                                            <span class="single_amount currency prefilled-amount">400</span>
                                        </div>
                                        <div class="tag bg-light rounded-10  mb-3 ">
                                            <span class="single_amount currency prefilled-amount">800</span>
                                        </div>
                                </div>
                                @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3 pb-1">
                                        <input type="email" class="form-control fs-14 text-dark" name="email"
                                    ...
                                    <input type="hidden" name="donation_commission" id="donationCommission"
                                           ...
                                           <div class="form-button donate-seperate-page-button">
                                            <button type="submit"
                                                    class="btn btn-primary me-3 donate-btn" >{{__('messages.payment.donate_now')}}</button>
