            ...
            <div class="card mb-5 mb-xl-10 border-0 px-10">
                ...
                <div class="collapse show">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-5">
                            {{ Form::label('annual_membership', __('messages.common.annual_membership').':', ['class' => 'form-label required']) }}
                            {{ Form::number('annual_membership', $setting['annual_membership'] ?? null, ['class' => 'form-control', 'required', 'placeholder' => __('messages.common.email') ]) }}
                        </div>
                        <div class="col-sm-6 mb-5">
