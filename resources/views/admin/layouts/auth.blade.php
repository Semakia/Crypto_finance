...
<body>
<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed authImage bg-primary">
    @yield('content')
</div>
<!--<footer style = "background-color : rgb(241, 187, 37)">
