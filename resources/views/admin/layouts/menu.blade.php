...
@can('manage_campaign')
    <li class="nav-item {{ Request::is('admin/campaign-categories*', 'admin/campaigns*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('campaigns.index') }}">
            ...
            <span class="aside-menu-title">{{ __('messages.campaign.projects') }}</span>
        </a>
    </li>
...
@endcan
    ...
    <li class="nav-item {{ Request::is('admin/levels*') ? 'active' : '' }}">
        <a class="nav-link d-flex align-items-center py-3" aria-current="page" href="{{ route('levels.index') }}">
            <span class="aside-menu-icon pe-3"><i class="fas fa-newspaper fs-3"></i></span>
            <span class="aside-menu-title">{{__('messages.levels.levels')}}</span>
        </a>
    </li>
